        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped data-tables table-responsive">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Lengkap</th>
                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group btn-group-sm">
                                                    <button type="button" class="btn btn-primary viewsemnas" data-toggle="modal" data-target="#modal-default" data-toggle="tooltip" data-placement="top" title="View" data-kode="<?= $row['kode']; ?>" data-nmlengkap="<?= $row['nama_lengkap']; ?>" data-nmrinduk="<?= $row['nomor_induk']; ?>" data-jnskelamin="<?= $row['jenis_kelamin']; ?>" data-asalinstansi="<?= $row['asal_instansi'] ?>" data-statusbayar="<?= $row['status_bayar']; ?>" data-email="<?= $row['email']; ?>" data-notelp="<?= $row['no_telp'] ?>"><i class="fas fa-eye"></i></button>
                                                    <button class="btn btn-success editsemnas" data-toggle="modal" data-target="#modal-editsemnas" data-toggle="tooltip" data-placement="top" title="Edit" data-kode="<?= $row['kode']; ?>" data-nmlengkap="<?= $row['nama_lengkap']; ?>" data-nmrinduk="<?= $row['nomor_induk']; ?>" data-jnskelamin="<?= $row['jenis_kelamin']; ?>" data-asalinstansi="<?= $row['asal_instansi'] ?>" data-statusbayar="<?= $row['status_bayar']; ?>" data-email="<?= $row['email']; ?>" data-notelp="<?= $row['no_telp'] ?>"><i class="fas fa-edit"></i></button>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control view_nmrinduk" readonly>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-body">  
                <div class="row">
                    ...
                    <form action="<?= base_url('admin/editsemnas'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nomor Induk</label>
                            <input type="text" class="form-control view_nmrinduk" name="nmr_induk">
                        </div>
                        <div class="form-group">
