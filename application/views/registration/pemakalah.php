...
<div class="contact-wrap">
    ...
    <div class="container">
        ...
        <?= form_open_multipart('registration/pemakalah'); ?>
        <form action="<?= base_url('registration/pemakalah'); ?>" method="post">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="form-group">
                        <label style="font-size: 15px; font-weight: 400" for="JudulTim">Judul</label>
                    ...
                    <div class="form-group">
                        <label style="font-size: 15px; font-weight: 400" for="namaPenulis">Nama Penulis</label>
                    ...
                    <div class="form-group">
                        <label style="font-size: 15px; font-weight: 400" for="subTema">Sub Tema</label>
                        <select class="form-control" id="subtema" name="subtema">
                            ...
                            <option value="Kontrol dan TI">Kontrol dan TI</option>
