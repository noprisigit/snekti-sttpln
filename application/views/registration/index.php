        ...
        <form action="<?= base_url('registration/getregist'); ?>" method="post">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label style="font-size: 15px; font-weight: 400" for="NomorInduk">Nomor Induk</label>
                        <input type="text" class="form-control" id="nomorinduk" name="nomorinduk" placeholder="Nomor Induk">
                        <?php echo form_error('nomorinduk', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
